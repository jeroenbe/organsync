...
from organsync.models.multitask import MultiTask_Network
...
@click.option("--weight_decay", type=float, default=0.0005)
...
@click.option("--dropout_prob", type=float, default=0.05)
